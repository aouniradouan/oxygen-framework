...
class Application extends Container
{
    ...
    protected function registerErrorHandling()
    {
        ...
        if ($debug) {
            // Development mode - use Whoops if available, otherwise use ErrorHandler
            ...
            if (class_exists(\Whoops\Run::class)) {
                ...
                // Fallback to ErrorHandler if Whoops is not available
                \Oxygen\Core\Error\ErrorHandler::register();
            }
        } else {
            // Production mode - use ErrorHandler
    ...
    public function run()
    {
        ...
        try {
            ...
            \Oxygen\Core\Error\ErrorHandler::handleException($e);
        }
    }
